...
export async function fetchConditions() {
  return request("/health/conditions");
}
...
export async function updateCondition(id, data) {
  return request(`/health/conditions/${id}`, {
    method: "PUT",
    body: JSON.stringify(data),
  });
}
export async function deleteCondition(id) {
  return request(`/health/conditions/${id}`, { method: "DELETE" });
}

// Allergies
export async function fetchAllergies() {
  return request("/health/allergies");
}
...
export async function updateAllergy(id, data) {
  return request(`/health/allergies/${id}`, {
    method: "PUT",
    body: JSON.stringify(data),
  });
}
export async function deleteAllergy(id) {
  return request(`/health/allergies/${id}`, { method: "DELETE" });
}

// Medications
export async function fetchMedications() {
  return request("/health/medications");
}
...
export async function updateMedication(id, data) {
  return request(`/health/medications/${id}`, {
    method: "PUT",
    body: JSON.stringify(data),
  });
}
export async function deleteMedication(id) {
  return request(`/health/medications/${id}`, { method: "DELETE" });
}

// Lifestyle
export async function fetchLifestyle() {
  return request("/health/lifestyle");
}
export async function createLifestyle(data) {
  return request("/health/lifestyle", {
    method: "POST",
    body: JSON.stringify(data),
  });
}
export async function updateLifestyle(id, data) {
  return request(`/health/lifestyle/${id}`, {
    method: "PUT",
    body: JSON.stringify(data),
  });
}
export async function deleteLifestyle(id) {
  return request(`/health/lifestyle/${id}`, { method: "DELETE" });
}
...
export async function updateGoal(id, data) {
  return request(`/health/goals/${id}`, {
    method: "PUT",
    body: JSON.stringify(data),
  });
}
export async function deleteGoal(id) {
  return request(`/health/goals/${id}`, { method: "DELETE" });
}

// Measurements
export async function fetchMeasurements() {
  return request("/health/measurements");
}
...
export async function updateTimelineEvent(id, data) {
  return request(`/health/timeline/${id}`, {
    method: "PUT",
    body: JSON.stringify(data),
  });
}
export async function deleteTimelineEvent(id) {
  return request(`/health/timeline/${id}`, { method: "DELETE" });
}
...
export async function confirmExtraction(documentId, extractionId) {
  return request(`/reports/${documentId}/extractions/${extractionId}/confirm`, {
    method: "POST",
  });
}
export async function rejectExtraction(documentId, extractionId) {
  return request(`/reports/${documentId}/extractions/${extractionId}/reject`, {
    method: "POST",
  });
}
