...
from database.models import User, HealthProfile, HealthCondition, Allergy, Medication, Lifestyle, HealthGoal, Measurement, HealthDocument
...
class HealthContextBuilder:
    ...
    async def build_context(self, user_message: str, active_report_id: Optional[str] = None) -> str:
        """
